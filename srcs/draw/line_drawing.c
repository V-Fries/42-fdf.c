...
/*   Updated: 2022/12/01 02:27:06 by vfries           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_line_low_angle(t_img *img, t_2d_point_i start,
	t_2d_point_i end)
{
	double	current_y;
	double	coef;
...
static void	draw_line_high_angle(t_img *img, t_2d_point_i start,
	t_2d_point_i end)
{
	double	current_x;
	double	coef;
